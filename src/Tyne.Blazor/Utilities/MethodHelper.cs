...
namespace Tyne.Blazor.Utilities;

/// <summary>
///		Helper methods for working with <see cref="MethodInfo"/>s.
/// </summary>
public static class MethodHelper
{
    /// <summary>
    ///     The default <see cref="BindingFlags"/> used when getting methods.
    /// </summary>
    /// <remarks>
    ///     By default, these filter to only public, non-inherited members (either instance or static).
    /// </remarks>
    public const BindingFlags DefaultBindingFlags =
        // Do not consider inherited methods
    ...
    public static MethodInfo Get<TType>(string methodName, BindingFlags bindingFlags) =>
        Get(typeof(TType), methodName, bindingFlags);

    /// <inheritdoc cref="Get{TType}(string, BindingFlags)"/>
    public static MethodInfo Get<TType>(string methodName) =>
        Get(typeof(TType), methodName, DefaultBindingFlags);
    ...
    /// </summary>
    /// <inheritdoc cref="Get{TType, TParam1, TParam2, TParam3, TParam4}(string, BindingFlags)"/>
    public static MethodInfo Get<TType, TParam1>(string methodName, BindingFlags bindingFlags) =>
        Get(typeof(TType), methodName, bindingFlags, typeof(TParam1));

    /// <inheritdoc cref="Get{TType, TParam1}(string, BindingFlags)"/>
    public static MethodInfo Get<TType, TParam1>(string methodName) =>
        Get(typeof(TType), methodName, DefaultBindingFlags, typeof(TParam1));
    ...
    /// </summary>
    /// <inheritdoc cref="Get{TType, TParam1, TParam2, TParam3, TParam4}(string, BindingFlags)"/>
    public static MethodInfo Get<TType, TParam1, TParam2>(string methodName, BindingFlags bindingFlags) =>
        Get(typeof(TType), methodName, bindingFlags, typeof(TParam1), typeof(TParam2));

    /// <inheritdoc cref="Get{TType, TParam1, TParam2}(string, BindingFlags)"/>
    public static MethodInfo Get<TType, TParam1, TParam2>(string methodName) =>
        Get(typeof(TType), methodName, DefaultBindingFlags, typeof(TParam1), typeof(TParam2));
    ...
    /// </summary>
    /// <inheritdoc cref="Get{TType, TParam1, TParam2, TParam3, TParam4}(string, BindingFlags)"/>
    public static MethodInfo Get<TType, TParam1, TParam2, TParam3>(string methodName, BindingFlags bindingFlags) =>
        Get(typeof(TType), methodName, bindingFlags, typeof(TParam1), typeof(TParam2), typeof(TParam3));

    /// <inheritdoc cref="Get{TType, TParam1, TParam2, TParam3}(string, BindingFlags)"/>
    public static MethodInfo Get<TType, TParam1, TParam2, TParam3>(string methodName) =>
        Get(typeof(TType), methodName, DefaultBindingFlags, typeof(TParam1), typeof(TParam2), typeof(TParam3));
    ...
    public static MethodInfo Get<TType, TParam1, TParam2, TParam3, TParam4>(string methodName, BindingFlags bindingFlags) =>
        Get(typeof(TType), methodName, bindingFlags, typeof(TParam1), typeof(TParam2), typeof(TParam3), typeof(TParam4));

    /// <inheritdoc cref="Get{TType, TParam1, TParam2, TParam3, TParam4}(string, BindingFlags)"/>
    public static MethodInfo Get<TType, TParam1, TParam2, TParam3, TParam4>(string methodName) =>
        Get(typeof(TType), methodName, DefaultBindingFlags, typeof(TParam1), typeof(TParam2), typeof(TParam3), typeof(TParam4));
    ...
    public static MethodInfo Get(Type declaringType, string methodName, BindingFlags bindingFlags, params Type[] parameterTypes)
    {
        ...
        // These are calculated by Name rather than FullName or AssemblyQualifiedName as those can be null for generic parameters.
        var parameterTypeNames = parameterTypes.Select(type => type.Name);
        ...
        // This may happen when a method has generic overloads (e.g. void Get(), and void Get<T>())
