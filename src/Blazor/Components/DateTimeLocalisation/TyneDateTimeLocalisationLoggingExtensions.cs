...
{
    [LoggerMessage(EventId = 101_003_001, Level = LogLevel.Error, Message = "TimeZone '{TimeZoneId}' reported by browser was not found in system cache. Falling back to custom time zone.")]
