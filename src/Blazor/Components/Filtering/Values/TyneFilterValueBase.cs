...
public abstract class TyneFilterValueBase<TRequest, TValue> : ComponentBase, IFilterValue<TRequest, TValue>, IDisposable
{
    private delegate void ValueSetter(TRequest request, TValue value);
    ...
    private ValueSetter? _forSetter;
    ...
    protected sealed override void OnInitialized()
    {
        ...
        _forSetter = CreateForSetter(forKey.Key);
    }

    private ValueSetter? CreateForSetter(string forPropertyName)
    {
        ...
        return forSetMethodInfo.CreateDelegate<ValueSetter>();
    }
