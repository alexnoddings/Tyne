namespace Tyne.Aerospace.Client.Features.Systems.Filtering.Values.Select.Single.Custom;

public class ProbeDestinationValue<TRequest> : TyneFilterSelectSingleValueBase<TRequest, ProbeDestination>
{
    // This uses the same implementation of LoadAvailableValuesAsync as the multi select.
